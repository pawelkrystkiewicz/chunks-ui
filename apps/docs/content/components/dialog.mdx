import { DialogBasicExample, DialogBackdropExample, DialogControlledExample } from '@/examples/Dialog'
...
All Dialog parts are pass-throughs to the underlying Base UI [`Dialog`](https://base-ui.com/react/components/dialog#api-reference).
