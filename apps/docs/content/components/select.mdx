import { SelectBasicExample, SelectGroupedExample } from '@/examples/Select'
...
All parts accept the props from their corresponding Base UI [`Select`](https://base-ui.com/react/components/select#api-reference) sub-components.
