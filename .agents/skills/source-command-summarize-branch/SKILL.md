---
name: "source-command-summarize-branch"
description: "TL;DR summary of what a branch does"
---

# source-command-summarize-branch

Use this skill when the user asks to run the migrated source command `summarize-branch`.
