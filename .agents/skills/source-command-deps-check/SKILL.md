---
name: "source-command-deps-check"
description: "Check for outdated or vulnerable dependencies"
---

# source-command-deps-check

Use this skill when the user asks to run the migrated source command `deps-check`.
...
Save to `.Codex/output/deps-report-{date}.md`
