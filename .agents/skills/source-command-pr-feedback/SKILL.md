---
name: "source-command-pr-feedback"
description: "Analyze and address unresolved PR feedback comments"
---

# source-command-pr-feedback

Use this skill when the user asks to run the migrated source command `pr-feedback`.
...
Save the analysis to `.Codex/output/pr-feedback-{branch-name}.md`
